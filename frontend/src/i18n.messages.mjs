export const messages = {
  ko: {
    ...
    artifactsTitle: '산출물',
    runtimeTitle: '실행 근거',
    resultTabs: { seed: '조사 Seed', ecosystem: '생태계 지도', currents: '해류 관찰', report: '리포트' },
    evidenceLabels: { graphEngine: '생태계 지도', graphMemory: 'Graphiti 기억', notConfigured: '미연결', aquariumNative: 'Aquarium 자체 처리' },
    ...
    graphMemoryLabels: {
      native_pass: 'Graphiti 기억: 연결됨',
      warning: 'Graphiti 기억: 경고',
      not_configured: 'Graphiti 기억: 아직 미연결',
      not_native: 'Graphiti 기억: 미사용',
    },
    providerLabels: {
  ...
  zh: {
    ...
    artifactsTitle: '产物',
    runtimeTitle: '运行证据',
    resultTabs: { seed: '研究种子', ecosystem: '生态地图', currents: '水流观察', report: '报告' },
    evidenceLabels: { graphEngine: '生态地图', graphMemory: 'Graphiti 记忆', notConfigured: '未连接', aquariumNative: 'Aquarium 自身处理' },
    ...
    graphMemoryLabels: {
      native_pass: 'Graphiti 记忆：已连接',
      warning: 'Graphiti 记忆：警告',
      not_configured: 'Graphiti 记忆：尚未连接',
      not_native: 'Graphiti 记忆：未使用',
    },
    providerLabels: {
  ...
  en: {
    ...
    resultTabs: { seed: 'Research seed', ecosystem: 'Ecosystem map', currents: 'Currents', report: 'Report' },
    evidenceLabels: { graphEngine: 'Ecosystem map', graphMemory: 'Graphiti memory', notConfigured: 'Not configured', aquariumNative: 'Aquarium native' },
    ...
    graphMemoryLabels: {
      native_pass: 'Graphiti memory: connected',
      warning: 'Graphiti memory: warning',
      not_configured: 'Graphiti memory: not configured yet',
      not_native: 'Graphiti memory: not used',
    },
    providerLabels: {
