...
Cohesion: 0.13
Nodes (30): BaseModel, msg(), HandoffManifest, Ontology, OntologyEntity, Persona, PipelineResult, RunRecord (+22 more)
...
- **Why does `Aquarium Architecture Slice` connect `Community 1` to `Community 8`, `Community 15`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Aquarium Architecture Slice` connect `Community 2` to `Community 9`, `Community 13`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `run_aquarium_pipeline()` connect `Community 0` to `Community 12`?**
