...
## Corpus Check
- 34 files · ~12,949 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 372 nodes · 460 edges · 29 communities
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 38 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c56ddd0e`
...
1. `run_aquarium_pipeline()` - 29 edges
...
6. `Release — Aquarium` - 10 edges
7. `실행 단계` - 9 edges
8. `3. 주요 화면 제안` - 9 edges
9. `Aquarium 실행계획 — stub MVP에서 실제 BettaFish→MiroFish 통합 제품까지` - 9 edges
...
- `test_pipeline_supports_single_mode_and_english_locale()` --calls--> `run_aquarium_pipeline()`  [INFERRED]
  backend/tests/test_pipeline_contract.py → backend/app/domain/pipeline.py
- `run_bettafish_cli_adapter()` --calls--> `AdapterStage`  [INFERRED]
  backend/app/domain/adapters.py → backend/app/domain/contracts.py

## Communities (29 total, 0 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.11
Nodes (41): BaseModel, msg(), AdapterStage, HandoffManifest, Ontology, OntologyEntity, Persona, PipelineResult (+33 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (40): 목표, 1. 목표와 비목표, 11. Docs 구조, 12. 추천 초기 파일 구조, 13. Vertical slice 구현 순서, 14. 핵심 결정, 2. 최소 견고 아키텍처, 비목표 (+32 more)
...
Cohesion: 0.25
Nodes (7): 2026-06-29 — Initial MVP scaffold, 2026-06-29 — Real runner canary and state visibility, 2026-06-29 — Real runner release, 2026-06-30 — Native MiroFish runtime canary, 2026-06-30 — Runtime evidence labeling and multiverse expansion, 2026-06-30 — Standalone Aquarium native pivot, Changelog — Aquarium
...
## Knowledge Gaps
- **172 isolated node(s):** `Locale`, `Mode`, `Stage`, `ProviderKey`, `StatusKey` (+167 more)
...
- **Why does `Aquarium Architecture Slice` connect `Community 1` to `Community 16`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Aquarium Architecture Slice` connect `Community 2` to `Community 11`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
